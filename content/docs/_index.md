...
{{< callout type="info" >}}
This guide was last reviewed against **OpenClaw 2026.7.35**. If you're running a newer version, some details may have changed — check the [changelog](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md).
{{< /callout >}}
