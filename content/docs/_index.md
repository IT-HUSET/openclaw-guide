...
{{< cards >}}
  ...
  {{< card link="hardened-multi-agent" title="Egress Allowlisting" subtitle="Optional: give the computer agent network access to pre-approved hosts" icon="shield-check" >}}
